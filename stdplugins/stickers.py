...
async def _(event):
    ...
    packname = f"@iSawJig 's KangTheKanger Pack"
    packshortname = f"Id_750876551"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"Animated Pack by @iSawJig"
        packshortname = f"Id_750876551_as"  # format: Uni_Borg_userid
